...
`§2.p2` **Student:** Can the hydrogen that does embrittlement be H2?
...
`§5.p10` **Student:** So quenching it — in a way it's almost like an old aqueduct arch, where you have a compressive stress that helps hold it together. So when you quench it, it's creating internal stress that makes it harder, because of the structure of each, and more brittle.
